...
class ShiftEvent {
  ...
  factory ShiftEvent.fromShift(Shift shift) {
    final duration =
        ...
        60.0; // Convert minutes to hours (preserves fractional hours)
    final timeRange =
...
class EmployeeProfile {
  ...
  factory EmployeeProfile.fromEmployee(
    ...
    final totalWorkedHours = workedHours ?? 0.0;
    ...
    // Calculate salary
    final rate = hourlyRate ?? _getDefaultHourlyRate(employee.position);
    final calculatedSalary = totalWorkedHours * rate;

    // Calculate location statistics
    final locationStats = calculateLocationStats(shifts, totalWorkedHours);
  ...
  static const Map<String, double> positionRates = {
    'Уборщица': 250.0,
    'Кассир': 400.0,
    'Повар': 600.0,
    'Менеджер': 840.0,
  ...
  static double _getDefaultHourlyRate(String position) {
    return positionRates[position] ?? 400.0;
  }
