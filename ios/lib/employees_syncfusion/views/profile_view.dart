...
class _ProfileViewState extends State<ProfileView> {
  ...
  Widget _buildSalaryCard(EmployeeProfile profile) {
    ...
    final salaryFormatted =
        profile.calculatedSalary.toStringAsFixed(2).replaceAll('.', ',');
    final rateFormatted =
        profile.hourlyRate.toStringAsFixed(0).replaceAll('.', ',');
    ...
    return _buildCard(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          ...profile.locationStats.map((stat) => Padding(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                style: theme.textTheme.bodySmall?.copyWith(
                                  fontWeight: FontWeight.w600,
                                  color: _getLocationColor(stat.location),
                                ),
                              ),
                            ],
                          ),
                          ...
                          LinearProgressIndicator(
                            ...
                            valueColor: AlwaysStoppedAnimation(
                              _getLocationColor(stat.location),
                            ),
                          ),
                        ],
                      ),
  ...
  void _showEditProfileDialog(EmployeeProfile profile) {
    String selectedPosition = profile.role;
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      'Новая ставка: ${EmployeeProfile.positionRates[selectedPosition]} ₽/ч',
                      style: TextStyle(
                    ...
                    const SizedBox(height: 4),
                    Text(
                      'Зарплата будет пересчитана автоматически',
          ...
          actions: [
            ...
            FilledButton(
              onPressed: () {
                ...
                _viewModel.updateEmployeePosition(
                  profile.id,
                  selectedPosition,
                );
              },
  ...
  Color _getLocationColor(String location) {
    if (location.contains('ТЦ Мега')) return const Color(0xFFFF6B35);
    if (location.contains('Центр')) return const Color(0xFF00BCD4);
    if (location.contains('Аэропорт')) return const Color(0xFF9C27B0);
